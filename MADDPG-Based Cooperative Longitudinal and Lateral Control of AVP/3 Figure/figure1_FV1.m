...
% xlabel('Global X');
% ylabel('Global Y');
% legend('Reference path','DDPG', 'SA-DDPG\_no\_cl', 'SA-DDPG','Orientation','vertical','Location','northeast')
% set(gca,'FontName','Times New Roman','FontSize',16,'FontWeight','bold',LineWidth=1.3);
%% 
figure(2);  % 距离
